...
params.scenario= 'O1_100';           % The adopted ray tracing scenarios [check the available scenarios at www.aalkhateeb.net/DeepMIMO.html]
...
params.num_ant=[1, 64, 1];         % Number of the UPA antenna array on the x,y,z-axes for the active BSs
