...
%ML ingestion
%% THz
file = load('../DeepMIMO_dataset/dataset_100GHz_pred.mat');
...
if exist('DataStructures/100GHz_pred.mat','file')
    delete 'DataStructures/100GHz_pred.mat';
end
save('DataStructures/100GHz_pred.mat','-struct','s');
