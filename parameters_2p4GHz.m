...
params.scenario= 'O1_2p4';           % The adopted ray tracing scenarios [check the available scenarios at www.aalkhateeb.net/DeepMIMO.html]
...
params.num_ant=[1, 4, 1];         % Number of the UPA antenna array on the x,y,z-axes for the active BSs
...
params.num_ant_UE=[1, 1, 1];      % Number of the UPA antenna array on the x,y,z-axes for the active users
...
params.num_paths=9;                 % Maximum number of paths to be considered (a value between 1 and 25), e.g., choose 1 if you are only interested in the strongest path
