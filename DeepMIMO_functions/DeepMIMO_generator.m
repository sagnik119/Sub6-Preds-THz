...
function DeepMIMO_dataset = generate_data(params, params_inner)
    ...
    for t = 1:params.num_active_BS
        ...
        for user=1:params.num_user
            ...
            DeepMIMO_dataset{t}.user{user}.DoD_phi=TX{t}.channel_params(user).DoD_phi;
            DeepMIMO_dataset{t}.user{user}.DoD_theta=TX{t}.channel_params(user).DoD_theta;
            DeepMIMO_dataset{t}.user{user}.DoA_phi=TX{t}.channel_params(user).DoA_phi;
            DeepMIMO_dataset{t}.user{user}.DoA_theta=TX{t}.channel_params(user).DoA_theta;
            DeepMIMO_dataset{t}.user{user}.phase=TX{t}.channel_params(user).phase;
            DeepMIMO_dataset{t}.user{user}.ToA=TX{t}.channel_params(user).ToA;
            DeepMIMO_dataset{t}.user{user}.power=TX{t}.channel_params(user).power;
